...
begin
  ...
  begin
    ...
    begin
      RelPos := PByte(OffsetTable.Offsets[I]) - PByte(Proc);
      {$IFDEF CPUX64}
      ...
      {$ELSE}
      PInteger(P + RelPos)^ := (PByte(Proc) - P) + OffsetTable.Offsets[I]^;
      {$ENDIF}
    end;
  end;
